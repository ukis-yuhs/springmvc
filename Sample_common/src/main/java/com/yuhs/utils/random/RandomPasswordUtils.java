...
public class RandomPasswordUtils {
    ...
    public RandomPasswordUtils(int passwordLength, int minVariousType) {
    ...
    public String generateRandomPassword() {
        ...
        List<CharactorType> takeTypes = new ArrayList(Arrays.asList(CharactorType.values()));//因为需要做remove操作，所以需要new
        List<CharactorType> fixedTypes = Arrays.asList(CharactorType.values());//无需增删改操作，所以不需要new
        int typeCount = 0;
