...
public class ImageUtils {
     ...
     * @param bb 比例不对时是否需要补白：true为补白; false为不补白
     */
    public final static void scale3(String srcImageFile, String result, int height, int width, boolean bb) {
        try {
            double ratio = 0.0; // 缩放比例
     ...
     * @param x 修正值
     * @param y 修正值
     * @param alpha alpha 透明度：alpha 必须是范围 [0.0, 1.0] 之内（包含边界值）的一个浮点数字
     */
